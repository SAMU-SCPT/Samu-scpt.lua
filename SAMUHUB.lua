...
local trueData = "08a729a6f3b846d4b3e959f7c79d3efb"
local falseData = "db8f748b99e14199b9563097ed76f5fc"
...
(getgenv()).Load = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("SAMU HUB") then
			makefolder("SAMU HUB");
		end;
		if not isfolder("SAMU HUB/Blox Fruits/") then
			makefolder("SAMU HUB/Blox Fruits/");
		end;
		if not isfile(("SAMU HUB/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("SAMU HUB/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(_G.Settings));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("SAMU HUB/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"));
	...
	if Update:SaveSettings() then
		if readfile and writefile and isfile and isfolder then
			if not isfile(("SAMU HUB/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
				...
				writefile("SAMU HUB/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
			end;
		else
			return warn("Status : Undetected Executor");
		end;
